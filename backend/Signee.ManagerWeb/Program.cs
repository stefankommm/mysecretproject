...
builder.Services.AddScoped<IGroupService>(s => new GroupService(s.GetRequiredService<IGroupRepository>(), s.GetRequiredService<IDisplayRepository>(), s.GetRequiredService<IViewRepository>()));
